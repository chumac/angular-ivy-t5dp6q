...
import { ConnectEditorService } from './connect-editor.service';
import { IgxGridComponent } from 'igniteui-angular';
import { IAnalysisDetailLinkInfo, IEnterpriseStructureDetail } from '../../../../models/interfaces';
import { ProcessingEnterpriseStructureDetail, NotProcessingEnterpriseStructureDetail, getEnterpriseStructureDetails, SaveEnterpriseStructureDetailReconnect, isProcessingEnterpriseStructureDetail, LoadEnterpriseStructureDetails } from '../../../../store/enterprise-structure-detail';
import { IAnalysisDetail } from '@nutela/models/workforce/personnel';

@Component({
  selector: 'x365-fm-es-connect-editor',
  templateUrl: './connect-editor.component.html',
  styleUrls: ['./connect-editor.component.scss'],
  providers: [ConnectEditorService],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class ConnectEditorComponent  extends BaseFormComponent
  implements OnInit, OnDestroy {
    ...
    constructor(
      public fs: ConnectEditorService,
  ...
  onSubmit() {
    ...
    if(this.fs.valid) {
      ...
      this.store.dispatch(new SaveEnterpriseStructureDetailReconnect({ data: null, recordId: this.analysisDetailId, destinationId: this.destinationId}));
    }  else {
