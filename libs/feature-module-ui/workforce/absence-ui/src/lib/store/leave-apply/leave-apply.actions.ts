...
export enum LeaveApplyActionTypes {
  ...
  PROCESSING_FORM = '[LEAVE APPLY] Processing Form',
  NOT_PROCESSING_FORM = '[LEAVE APPLY] Not Processing Form',
  ...
  LOAD_LEAVE_SUBDETAIL = '[LEAVE APPLY] Load Leave Subdetail',
  LOAD_LEAVE_SUBDETAIL_SUCCESS = '[LEAVE APPLY] Load Leave Subdetail Success',
  ...
  RESET_ENTITLEMENT = '[LEAVE APPLY] Reset Entitlement',
...
export class ProcessingFormLeaveApply implements Action {
  readonly type = LeaveApplyActionTypes.PROCESSING_FORM;
}

export class NotProcessingFormLeaveApply implements Action {
  readonly type = LeaveApplyActionTypes.NOT_PROCESSING_FORM;
}
...
export class LoadSubDetailLeaveApply implements Action {
  readonly type = LeaveApplyActionTypes.LOAD_LEAVE_SUBDETAIL;

  constructor(public payload: { selectedLeaveType: ISelectOption, formData: ILeaveDailyData }) {}
}

export class LoadSubDetailLeaveApplySuccess implements Action {
  readonly type = LeaveApplyActionTypes.LOAD_LEAVE_SUBDETAIL_SUCCESS;
...
export class ResetEntitlementLeaveApply implements Action {
  readonly type = LeaveApplyActionTypes.RESET_ENTITLEMENT;
}
...
export type LeaveApplyActions =
  ...
  | ProcessingFormLeaveApply
  | NotProcessingFormLeaveApply
  ...
  | LoadSubDetailLeaveApply
  | LoadSubDetailLeaveApplySuccess
  | LoadInlineDocumentLeaveApply
  | ResetEntitlementLeaveApply;
