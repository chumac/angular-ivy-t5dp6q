...
export function leaveApplyReducer(
  ...
  switch (action.type) {
    ...
    case LeaveApplyActionTypes.PROCESSING_FORM:
      return { ...state, isProcessingForm: true };
    case LeaveApplyActionTypes.NOT_PROCESSING_FORM:
      return { ...state, isProcessingForm: false };
    case LeaveApplyActionTypes.LOAD_LEAVE_SUBDETAIL_SUCCESS:
    ...
    case LeaveApplyActionTypes.RESET_ENTITLEMENT:
      return { ...state, leaveEntitlement: null };
