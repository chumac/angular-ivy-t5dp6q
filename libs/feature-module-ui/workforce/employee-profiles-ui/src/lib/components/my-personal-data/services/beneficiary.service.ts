...
import { ShowEditorBeneficiary, LoadApprovedDataBeneficiary, LoadAwaitingApprovalDataBeneficiary, LoadDataBeneficiary } from '@nutela/store/modules/workforce/employee-profiles';
