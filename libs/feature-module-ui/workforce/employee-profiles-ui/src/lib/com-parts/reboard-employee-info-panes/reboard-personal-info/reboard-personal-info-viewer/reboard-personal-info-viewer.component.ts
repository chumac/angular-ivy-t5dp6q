...
@Component({
  selector: 'x365-fm-workforce-reboard-personal-info-viewer',
  templateUrl: './reboard-personal-info-viewer.component.html',
  styleUrls: ['./reboard-personal-info-viewer.component.scss']
})
export class ReboardPersonalInfoViewerComponent implements OnInit {
