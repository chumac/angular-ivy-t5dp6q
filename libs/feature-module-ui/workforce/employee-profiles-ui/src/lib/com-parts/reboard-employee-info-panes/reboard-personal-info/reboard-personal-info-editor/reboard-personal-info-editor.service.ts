...
} from './reboard-personal-info-editor.factory';


@Injectable({
  providedIn: 'root'
})
export class ReboardPersonalInfoEditorService {
  ...
  fieldData(data: IGeneral): IGeneral | {} {
    if (data) {
      return {
        ...
        employee_number: data.EmployeeInfo.employee_number,
        ...
        image_personal: data.image_personal ? data.image_personal : null,
        image_profile: data.image_profile ? data.image_profile: null,
        ...
        sys_surname: data.sync_surname,
        sys_firstname: data.sync_firstname,
