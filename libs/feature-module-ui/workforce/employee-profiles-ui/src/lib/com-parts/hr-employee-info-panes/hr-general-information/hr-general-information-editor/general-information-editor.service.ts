...
} from './general-information-editor.factory';
...
export class GeneralInformationEditorService {
  ...
  fieldData(data: IGeneral): IGeneral | {} {
    if (data) {
      return {
        ...
        employee_midname: data.employee_midname,
        employee_number: data.employee_number,
        employee_fileno: data.employee_fileno,
        ...
        emp_linkedin: data.emp_linkedin ? data.emp_linkedin: null,
        emp_facebook: data.emp_facebook ? data.emp_facebook: null,
        emp_twitterhandle: data.emp_twitterhandle ? data.emp_twitterhandle: null,
