...
@Component({
  selector: 'x365-fm-workforce-reboard-navigation-panel',
  templateUrl: './reboard-navigation-panel.component.html',
  styleUrls: ['./reboard-navigation-panel.component.scss']
})
export class ReboardNavigationPanelComponent implements OnInit {
