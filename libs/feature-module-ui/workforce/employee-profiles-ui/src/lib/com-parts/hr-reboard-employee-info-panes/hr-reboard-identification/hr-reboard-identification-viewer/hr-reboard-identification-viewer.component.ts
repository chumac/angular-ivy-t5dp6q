...
@Component({
  selector: 'x365-fm-workforce-hr-reboard-identification-viewer',
  templateUrl: './hr-reboard-identification-viewer.component.html',
  styleUrls: ['./hr-reboard-identification-viewer.component.scss']
})
export class HrReboardIdentificationViewerComponent implements OnInit {
