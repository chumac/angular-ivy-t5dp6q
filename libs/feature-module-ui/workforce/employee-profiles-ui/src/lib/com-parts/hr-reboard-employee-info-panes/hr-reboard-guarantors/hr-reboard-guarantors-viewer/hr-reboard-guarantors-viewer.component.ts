...
@Component({
  selector: 'x365-fm-workforce-hr-reboard-guarantors-viewer',
  templateUrl: './hr-reboard-guarantors-viewer.component.html',
  styleUrls: ['./hr-reboard-guarantors-viewer.component.scss']
})
export class HrReboardGuarantorsViewerComponent implements OnInit {
