...
} from './hr-reboard-personal-info-editor.factory';


@Injectable({
  providedIn: 'root'
})
export class HrReboardPersonalInfoEditorService {
    ...
    return this.fb.group(
      {
        ...
        employee_fileno: [''],
        is_v2_update: [false],
        is_image_prof_upd: [false],
        is_image_file_upd: [false],
        sync_firstname: [''],
        sync_surname: [''],
      },
      {
  ...
  fieldData(data: IGeneral): IGeneral | {} {
    if (data) {
      return {
        ...
        birth_country_id: data.BirthCountryInfo ? data.BirthCountryInfo.nationality_id : null,
        birthstate_id: data.BirthStateInfo ? data.BirthStateInfo.state_id : null,
        city_id: data.AreaInfo ? data.AreaInfo.city_id : null,
        nationality_id: data.NationalityInfo ? data.NationalityInfo.nationality_id : null,
        state_id: data.StateInfo ? data.StateInfo.state_id : null,
        lga_id: data.LGAInfo ? data.LGAInfo.lga_id : null,
        religion_id: data.ReligionInfo ? data.ReligionInfo.religion_id : null,
        ...
        sync_surname: data.sync_surname,
        sync_firstname: data.sync_firstname,
  ...
  get preferedFirstname(): AbstractControl {
    return this.form.get('sync_firstname');
  }

  get preferedSurname(): AbstractControl {
    return this.form.get('sync_surname');
  }
