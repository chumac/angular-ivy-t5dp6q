...
export const COURSE_TYPE: { value: number, label: string }[] = [
  { value: 0, label: 'Standard' },
  { value: 1, label: 'Online' },
];

export const EVENT_TYPE: { value: number, label: string }[] = [
  { value: 1, label: 'ONGOING' },
  { value: 2, label: 'UPCOMING' },
  { value: 3, label: 'RECENTLY COMPLETED' },
  { value: 4, label: 'RECOMMENDED' },
  { value: 5, label: 'APPLICATIONS' },
  { value: 6, label: 'HISTORY' },
  { value: 7, label: 'MY EVENTS' },
];
